                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index.html" class="logo logo-dark">
                            ...
                            <span class="logo-lg">
                                <img src="{{ asset('backend')}}/assets/images/logo-light.png" alt="logo-dark" height="40">
                            </span>
                        </a>
                        ...
                        <a href="index.html" class="logo logo-light">
                            ...
                            <span class="logo-lg">
                                <img src="{{ asset('backend')}}/assets/images/logo-dark.png" alt="logo-light" height="40">
                            </span>
                        </a>
                    </div>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block user-dropdown">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <img class="rounded-circle header-profile-user" src="{{(!empty($data->profile_image))? url('uploads/admin_images/'.$data->profile_image): url('uploads/no_image.jpg')}}"
                                alt="">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="{{route('admin.password')}}"><i class="ri-wallet-2-line align-middle me-1"></i> Change Password</a>
